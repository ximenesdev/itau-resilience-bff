...
public class ModoFalha {
    ...
    // POST /admin/falha/ativar) e LIDO por outra (a requisição GET /investimentos que
    // chega logo em seguida). Sem o volatile, uma thread poderia não "enxergar" a
    // mudança feita pela outra, por causa de cache de CPU. O volatile garante
